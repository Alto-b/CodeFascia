...
class _ProfilePageState extends State<ProfilePage> {
  ...
  final List<String> skillItems = ['Student', 'Working IT', 'Working Non IT'];
  ...
  Future<void> updateProfile(BuildContext context, String newImg) async {
    ...
    firebasestorage.Reference ref = firebasestorage.FirebaseStorage.instance
        .ref("profilepic${FirebaseAuth.instance.currentUser!.uid}");
    firebasestorage.UploadTask uploadTask = ref.putFile(file);
    try {
      log("entered try of updateProfile()");
      await uploadTask;
      var downloadUrl = await ref.getDownloadURL();
      log("user profile details : name : ${_nameController.text},prof : ${selectedSkill},email : ${_emailController.text},");
